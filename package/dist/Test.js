...
var hasRequiredLoadableContext;

function requireLoadableContext () {
	if (hasRequiredLoadableContext) return loadableContext;
	hasRequiredLoadableContext = 1;
	(function (exports) {
		"use client";
		...
		const _react = /*#__PURE__*/ _interop_require_default._(reactExports);
...
var hasRequiredLoadable;

function requireLoadable () {
	if (hasRequiredLoadable) return loadable;
	hasRequiredLoadable = 1;
	(function (exports) {
		Object.defineProperty(exports, "__esModule", {
		    value: true
		});
		...
		const _interop_require_default = _interop_require_default$1;
		const _react = /*#__PURE__*/ _interop_require_default._(reactExports);
		const _loadablecontext = requireLoadableContext();
...
(function (module, exports) {
	...
	const _interop_require_default = _interop_require_default$1;
	const _react = /*#__PURE__*/ _interop_require_default._(reactExports);
	const _loadable = /*#__PURE__*/ _interop_require_default._(requireLoadable());
...
let TestElement = class TestElement extends s {
    constructor() {
        super(...arguments);
        this.name = "world";
    }
    render() {
        return x `<div>${this.name}<slot></slot></div>`;
    }
};
__decorate([
    n$2({ type: String }),
...
const Testing = dynamic$1(() => Promise.resolve(reactCom), {
    ssr: false,
});
// declare global {
//   namespace JSX {
